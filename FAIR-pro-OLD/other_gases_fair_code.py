#NOTE: This code is a copy off nick to produce a draft version of the figure displaying the
#       annual CO2-fe and GWP100 emissions for each of the gases currently defined under the
#       other contribution in the main figure. 
